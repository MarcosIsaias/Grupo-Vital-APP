                        ...
                        <div class="col-6">
                            <form>
                                ...
                                <div class="form-group">
                                    <label for="idade" class="textPerson">Idade</label>
                                    <input type="number" class="form-control amber darken-4 rounded" id="Idade">
                                </div>
                                ...
                                <!--Formulario do peso-->
                                <div class="form-group">
                                    <label for="peso" class="textPerson">Peso</label>
                                    <input type="number" class="form-control amber darken-4 rounded" id="Peso"
                                        maxlength="4" minlength="4" step="0.01" min="0">
                                </div>
                            </form>
                        </div>
